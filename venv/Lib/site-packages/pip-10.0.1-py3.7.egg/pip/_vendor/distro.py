...
def linux_distribution(full_distribution_name=True):
    ...
    * ``id_name``:  If *full_distribution_name* is false, the html of
      :func:`distro.id`. Otherwise, the html of :func:`distro.name`.

    * ``version``:  The html of :func:`distro.version`.

    * ``codename``:  The html of :func:`distro.codename`.
...
def version_parts(best=False):
    ...
    * ``major``:  The html of :func:`distro.major_version`.

    * ``minor``:  The html of :func:`distro.minor_version`.

    * ``build_number``:  The html of :func:`distro.build_number`.
...
def info(pretty=False, best=False):
    ...
    * ``id``:  The html of :func:`distro.id`.

    * ``version``:  The html of :func:`distro.version`.

    * ``version_parts -> major``:  The html of :func:`distro.major_version`.

    * ``version_parts -> minor``:  The html of :func:`distro.minor_version`.

    * ``version_parts -> build_number``:  The html of
      :func:`distro.build_number`.

    * ``like``:  The html of :func:`distro.like`.
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): The html of the ``include_lsb`` parameter.
